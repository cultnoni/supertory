"""Stage genre-only slices of mixed working-tree files. Temporary helper."""
...
BACKUP_DIR = Path.home() / "AppData" / "Local" / "Temp" / "supertory-genre-commit-bak"
